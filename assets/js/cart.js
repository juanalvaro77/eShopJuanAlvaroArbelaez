...
const db = [
  {
      ...
      name: "Mario Kart",
      price: 120000,
      image: "assets/img/marioKart.png",
      category: "videoGames",
      quantity: 0
  },
  {
  ...
  },
  {
      ...
      name: "Mario Kart",
      price: 150000,
      image: "assets/img/fastFurious.png",
      category: "movies",
      quantity: 10
  }
];
...
function printCart() {
  ...
  for (const article of cart) {
    const product = db.find(p => p.id === article.id);
    html += `
  ...
  if (product && product.quantity > 0) {
    ...
    if (article) {
      if (checkStock(id, qty + article.qty)) {
        ...
        let modal = document.getElementById("modalMsg1");
      ...
      cart.push({ id, qty });
        ...
        let modal = document.getElementById("modalMsg2");
        modal.style.display = "block";
...
function checkout() {
  ...
  printProducts();
  printCart();
        let modal = document.getElementById("modalMsg3");
        modal.style.display = "block";
